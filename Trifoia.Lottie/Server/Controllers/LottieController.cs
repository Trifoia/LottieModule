...
namespace Trifoia.Lottie.Controllers
{
    ...
    public class LottieController : ModuleControllerBase
    {
        ...
        public Models.Lottie Get(int id)
        {
            ...
            if (Lottie != null && Lottie.ModuleId == AuthEntityId(EntityNames.Module))
            {
                return Lottie;
            }
            else
        ...
        {
            if (ModelState.IsValid && Lottie.ModuleId == AuthEntityId(EntityNames.Module))
            {
        ...
        {
            if (ModelState.IsValid && Lottie.ModuleId == AuthEntityId(EntityNames.Module) && _LottieRepository.GetLottie(Lottie.LottieId, false) != null)
            {
