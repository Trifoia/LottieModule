...
namespace Trifoia.Lottie.Migrations.EntityBuilders
{
    public class LottieEntityBuilder : AuditableBaseEntityBuilder<LottieEntityBuilder>
    {
        private const string _entityTableName = "TrifoiaLottie";
        private readonly PrimaryKey<LottieEntityBuilder> _primaryKey = new("PK_TrifoiaLottie", x => x.LottieId);
        private readonly ForeignKey<LottieEntityBuilder> _moduleForeignKey = new("FK_TrifoiaLottie_Module", x => x.ModuleId, "Module", "ModuleId", ReferentialAction.Cascade);
